...
#! 单机
#todo(use cuda:0)       torchrun /home/hby/cangnm_code/AE_paralled.py
...
#! 指定网卡
#todo(机器 1)   GLOO_SOCKET_IFNAME=enp0s3 torchrun --nnodes=3 --nproc_per_node=1 --rdzv_id=0 --rdzv_backend=c10d --rdzv_endpoint=192.168.56.101:29400 /home/hby/cangnm_code/AE_paralled.py
#todo(机器 2)   GLOO_SOCKET_IFNAME=enp0s3 torchrun --nnodes=3 --nproc_per_node=1 --rdzv_id=0 --rdzv_backend=c10d --rdzv_endpoint=192.168.56.101:29400 /home/hby/cangnm_code/AE_paralled.py
#todo(机器 3)   GLOO_SOCKET_IFNAME=enp0s3 torchrun --nnodes=3 --nproc_per_node=1 --rdzv_id=0 --rdzv_backend=c10d --rdzv_endpoint=192.168.56.101:29400 /home/hby/cangnm_code/AE_paralled.py

#! (2) torch.distributed.launch(不同机器上运行需要调整 node_rank)
#   nnodes: 并行机器数量
#   node_rank: rank, 主节点 node_rank 为 0
#   nproc_per_node: 每台机器上的可用卡
#   master_addr: 主节点地址
#   master_port: 主节点端口

#! 指定网卡
#todo(机器 1)   GLOO_SOCKET_IFNAME=enp0s3 python -m torch.distributed.launch --nnodes=3 --node_rank=0 --master_addr 192.168.56.101 --master_port 29400 --use_env /home/hby/cangnm_code/AE_paralled.py
#todo(机器 2)   GLOO_SOCKET_IFNAME=enp0s3 python -m torch.distributed.launch --nnodes=3 --node_rank=1 --master_addr 192.168.56.101 --master_port 29400 --use_env /home/hby/cangnm_code/AE_paralled.py
#todo(机器 3)   GLOO_SOCKET_IFNAME=enp0s3 python -m torch.distributed.launch --nnodes=3 --node_rank=2 --master_addr 192.168.56.101 --master_port 29400 --use_env /home/hby/cangnm_code/AE_paralled.py
